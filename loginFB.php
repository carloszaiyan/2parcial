<?php
	...
	FacebookSession::setDefaultApplication( '629131517802631','58050d274f93752c22e1ec198bfe2bbe' );
	$helper = new FacebookRedirectLoginHelper('http://127.0.0.1/Social_Login/index.php/loginFB.php');
